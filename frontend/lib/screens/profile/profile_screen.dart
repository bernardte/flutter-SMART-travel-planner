...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
          appBar: AppBar(), body: const Center(child: Text('User not found')));
    }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _ProfileStat(
                            value:
                                '${_stats['totalTrips'] ?? _publishedGuides.length}',
                            label: 'Guides'),
                      ],
                    ),
                    if (!isOwnProfile) ...[
                      ...
                      ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              _isFollowing ? Colors.grey[200] : null,
                    ...
                    if (_publishedGuides.isEmpty)
                      Center(
                        child: Padding(
                          ...
                          child: Text('No published guides yet',
              ...
              Center(
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (picked != null)
                      setModal(() => newPicture = File(picked.path));
                  },
                  child: CircleAvatar(
                    radius: 36,
